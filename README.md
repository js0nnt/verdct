...
| --- | --- |
| `npm test` | 152 unit tests across the scanner, matcher, RMP parser, cache, and badge renderer. |
...
Latest `validate:asu` run: 17 of 17 rows badged, 0 unresolved, 7 trend arrows, 1 best section highlighted, 8 professors reported to the popup with a matching toolbar badge, 0 page errors.
