...
| --- | --- |
| `npm test` | 52 unit tests across the scanner, matcher, RMP parser, cache, and badge renderer. |
...
Latest `validate:asu` run: 17 of 17 rows badged, 0 unresolved, 0 page errors.
